...
INPUT_LAYER_SIZE = 12  # Changing requires adding or removing actual inputs
...
class Controller(BaseController):
    ...
    def update(
        ...
        # Calculate second error derivative (error jerk)
        error_deriv2 = error_deriv - self.prev_error

        # Future plan variability
        future_std = (
            np.std(future_plan.lataccel[:10])
